...
| KS3 Y8 U2 Computing systems | L1–L5 | Antikythera still, system-monitor still, ~~logic-gate symbols chart~~, AI-examples strip | ⚠️ embedded OGL alternatives + 3 system-monitor videos. **Sweep audit 2026-06-28:** the "logic-gate symbols" want was MIS-SPECIFIED — L4 teaches NOT/AND/OR as **Boolean operators via truth tables + switch circuits**, not formal gate symbols, and already has the adder-circuit + Boole images. No change needed. |
...
| GCSE U2 Computer systems pt2 | L10 logic gates — activity/slides | a CLEAN AND/OR/NOT **gate-symbol** image | ✅ **RESOLVED 2026-06-28** (sweep): rasterised the AND (slide 18), OR (slide 37) and NOT (slide 40) symbols from the source deck via Gotenberg and embedded them on the "three gates" slide + worksheet — pupils now SEE the symbols the lesson asks them to recognise |
