...
- name real-world uses of desktop publishing
- say why desktop publishing is helpful
- compare desktop publishing to work made by hand
...
- magazines, posters, invitations, newspapers
...
- newspaper editors → the news

> 🧑‍🏫 This is the sort task on the worksheet. Collect more jobs on sticky notes if there is time.

## The benefits
- quick to copy many times
- easy to change
- always looks neat and the same
...
> 🧑‍🏫 The "race" idea: by hand you redraw every change and every copy. This is the Core and Challenge questions. Keep it calm, no rush.

## I can…
- tick your three "I can…"
- show me one piece of work you made this unit

> 🧑‍🏫 Note who can give a real benefit of desktop publishing on their own. Celebrate the unit's finished work.
