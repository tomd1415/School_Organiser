...
![Seating codes and prices]({{res:l2-seating-codes-and-prices-teach-computing.png}})
...
![A seating plan using drop-down seat codes]({{res:l2-seating-plan-with-data-validation-teach-computing.png}})
