...
- make a column chart
- make a pie chart
- give a chart a clear title and labels
...
- give it a clear title; move it to its own sheet
...
- a pie chart is the WRONG choice for comparing separate groups
...
- the wrong chart can skew the message

> 🧑‍🏫 Use the sort task on the worksheet. The grouped column compares Adult/Student/Over 60s across sections — a job a pie cannot do.

## Your turn
Make a column chart and a pie chart from your spreadsheets. Title and label them clearly.

> 🧑‍🏫 Support: pair them, give the completed Lesson 1/2 sheets if missing. TA: prompt, do not do it for them. They screenshot one chart onto the activity worksheet.

## I can…
Tick your four "I can…". Show me one chart you made.

> 🧑‍🏫 Note who can say WHY they picked column or pie.
