...
![Seating codes and seating prices tables]({{res:l2-seating-codes-and-prices-teach-computing.png}})
...
![A seating plan where each seat uses a drop-down list of codes]({{res:l2-seating-plan-with-data-validation-teach-computing.png}})
