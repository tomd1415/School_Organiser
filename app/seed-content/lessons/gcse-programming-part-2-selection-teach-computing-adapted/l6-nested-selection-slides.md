...
![Two eggs inside a bird's nest]({{res:l6-two-eggs-in-a-nest-teach-computing.png}})
...
## Guess the animal
![The guess-the-animal program]({{res:l6-guess-the-animal-program-teach-computing.png}})
