...
- use a comparison operator (< > =) in an "if… then…" statement
- explain why the order of conditions matters
- change a program to make a micro:bit compass
...
> 🧑‍🏫 On the activity worksheet pupils match a heading to a direction. North is special — it is at 0° and 360°.

## Comparison operators < > =
- `<` less than · `>` greater than · `=` equal to
- "compass heading < 45" is true when the heading is under 45
...
- the wrong order gives the wrong answer
...
> 🧑‍🏫 Pupils order the simple compass (Parsons), then build it in MakeCode and add more directions. TA: prompt, do not build it for them.

## I can…
Tick your three "I can…". Tell me what `<` means.

> 🧑‍🏫 Listen for "less than". Movement break before the next lesson.
