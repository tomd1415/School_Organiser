...
## Translate it  (we do)
![Password pseudocode to translate]({{res:l5-pseudocode-to-python-teach-computing.png}})
...
![FizzBuzz: the number sequence and its output]({{res:l5-fizzbuzz-sequence-and-output-teach-computing.png}})
