...
- choose the artwork (sprites and background) for a game
- write an algorithm for a game
...
- there is a **score** and a **timer**

> 🧑‍🏫 Pupils tick what they can see on the starter worksheet. You will design your own version of this game.

## Choose your artwork
- choose **two sprites** to fall down
- choose a **background**
- a sprite is a character or object; the background is the scene behind
...
- pupils fill in and order the algorithm

> 🧑‍🏫 Likely error: "an algorithm is the code." Fix-words: "an algorithm is the PLAN; code comes next." Challenge: explain your design choices.

## I can…
Tick your four "I can…". Tell me one thing: what is an algorithm?

> 🧑‍🏫 Listen for "a set of steps / a plan". Keep designs safe for next lesson. Movement break before the next lesson.
