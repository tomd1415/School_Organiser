...
- explain what an item of data is
- choose a suitable format for a cell
- apply a format to a cell
...
- formats: Plain text, Number, Currency, Date, Duration
...
> 🧑‍🏫 Model applying Currency to one cell, then pupils try. TA: prompt the menu path, do not click it for them. Challenge: why format money as Currency?

## I can…
Tick your three "I can…". Tell me one thing: what is a cell reference?

> 🧑‍🏫 Listen for "the cell's address, like A1". Movement break before the next lesson.
