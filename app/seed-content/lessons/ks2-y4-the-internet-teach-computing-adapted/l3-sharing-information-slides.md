...
- say what media can be shared on the web
- describe where websites are stored
- describe how we get to a website
...
- data centres are all around the world
...
> 🧑‍🏫 Name the common browsers: Chrome, Safari, Edge, Firefox. Misconception to fix: "you need Google to use the internet" — Google is a search engine; Chrome is the browser.

## Open a website
- open one website in a browser
- find which browser you are using
- screenshot it for show-your-work

> 🧑‍🏫 You-do. Calm browsing of ONE site. TA: prompt, do not click for them. Movement break is routine.

## I can…
Tick your "I can…". Tell me where a website is stored.

> 🧑‍🏫 Check pupils can say "on a server, in a data centre" and name one browser. Next lesson: what is a website made of, and adding your own content.
