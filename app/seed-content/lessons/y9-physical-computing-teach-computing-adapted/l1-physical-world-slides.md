...
## Meet the micro:bit
![The front of the micro:bit board]({{res:l1-microbit-front-teach-computing.png}})
...
![The back of the micro:bit, components labelled]({{res:l1-microbit-back-labelled-teach-computing.png}})
