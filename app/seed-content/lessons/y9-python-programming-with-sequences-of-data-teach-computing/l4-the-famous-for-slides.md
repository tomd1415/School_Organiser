...
![The cover of the novel Gadsby, a 50,000-word novel written without the letter E]({{res:l4-gadsby-novel-cover-teach-computing.jpg}})
...
![A plotted ECG signal with red dots marking zero crossings]({{res:l4-heartbeats-ecg-plot-teach-computing.png}})
