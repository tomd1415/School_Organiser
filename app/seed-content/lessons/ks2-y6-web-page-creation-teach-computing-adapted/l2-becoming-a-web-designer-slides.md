...
- recognise the common features of a web page
- suggest media for my page
- draw a web page layout that suits my purpose
...
- games + 18+ + card details → made for adults
...
> 🧑‍🏫 Walk the videos: new site, site name, header types, layouts. Today is planning only — we build next time. Support pupils choose where the logo goes and what the header is.

## Plan your page
- give it a website name and a logo
- choose a header and some layouts
- think about your audience and purpose

> 🧑‍🏫 Pupils draw their home page on paper (design sheet + help sheet). Leave the example on the board. Challenge: match the header/pictures to a young audience. Show your work: screenshot the design.

## I can…
Tick your three "I can…". Tell me one feature of a web page.

> 🧑‍🏫 Listen for header / logo / layout / media. Movement break before next lesson.
