...
- say what data science means
- explain how visualising data helps us spot patterns
- use a tool to make a visualisation and find an insight
...
> 🧑‍🏫 Do NOT reveal the story yet. The point: raw numbers are hard to read. Most pupils will not crack it — that is expected and fine.
...
> 🧑‍🏫 We-do the card-sort on the worksheet together first. Likely error: pie chart used for time. Fix-words: "pie = parts of ONE whole, not over time."

## Your turn — visualise the data  (you do)
Make a chart of the TV viewing data. Paste a screenshot + write one insight.

> 🧑‍🏫 Support: pick the chart for them and name it. Core: choose their own chart. Challenge: say who the insight helps. TA: "prompt, do not do it for them." Movement break is routine here.

## I can…
Tick your three "I can…". Show me your chart and your one insight.

> 🧑‍🏫 Note who made a chart and found a genuine insight. Homework: visualise the planetary data set.
