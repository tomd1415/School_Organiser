# Statistical state of mind

## Today we are learning
- explain what correlation and outliers mean
- put the investigative cycle (PPDAC) in order
- use the cycle on a data set and make a recommendation
...
> 🧑‍🏫 The dips line up with real events (war, illness). Outlier ≠ always an error — check before deleting. Example: an age typed as 130.

## The investigative cycle — PPDAC
...
> 🧑‍🏫 Support: give a ready question to investigate. Challenge: say whether the data is enough. TA: prompt only. Movement break is routine here.

## I can…
Tick your three "I can…". Tell me your recommendation and the data behind it.

> 🧑‍🏫 Note who ordered PPDAC and backed a recommendation with the data.
