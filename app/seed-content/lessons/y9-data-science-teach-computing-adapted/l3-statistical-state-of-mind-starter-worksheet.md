# Statistical state of mind — starter worksheet
...
| Question | Choose one |
|---|---|
| The points that drop sharply (1871, 1918, 1940) are… | (  ) outliers (  ) the trend (  ) the average |

## 🟢 Support
| Question | Choose one |
|---|---|
| A correlation is when two things… | (  ) change together (  ) are exactly equal (  ) are missing |

## 🟡 Core
| Question | Your answer |
|---|---|
| Why might a year like 1918 be much lower than the years around it? (Think: what big event happened?) | Type your answer here |

## 🔴 Challenge
| Question | Your answer |
|---|---|
| Should you delete an outlier straight away, or check it first? Explain why. | Type your answer here |
