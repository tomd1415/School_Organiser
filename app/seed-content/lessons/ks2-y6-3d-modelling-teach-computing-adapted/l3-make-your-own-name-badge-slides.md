...
- to rotate objects in three dimensions
- to duplicate 3D objects
- to group 3D objects
- to make our own 3D name badge
...
- today we will make our own badge
...
- after rotating, part of a shape may dip below the workplane
...
- you can then resize, rotate or recolour the copy
...
- a grouped object shows as one colour; ungroup to get the colours back

> 🧑‍🏫 Pupils order the grouping steps. Challenge: why group the badge before moving it? (so the parts stay together).

## Make your name badge
- add a base, your name in text, and a duplicated shape
- group it when you are happy
- save and screenshot your work

> 🧑‍🏫 You-do. Give plenty of time. Plenary idea: could it be 3D printed? The letters need a base under them or they would print in mid-air. Pupils self-tick the four "I can…".
