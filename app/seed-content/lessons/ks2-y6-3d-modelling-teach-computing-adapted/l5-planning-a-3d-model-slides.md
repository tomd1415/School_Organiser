...
- to analyse a 3D model to find its shapes
- to choose objects to use in a 3D model
- to combine objects in a design
- to plan our own 3D building
...
- they can view it from any side and resize parts easily
...
- pulling a model apart shows the shapes inside
...
- pupils match each building to its main shape
...
- think about size: how big are the windows next to the door?

> 🧑‍🏫 You-do. Use shapes that exist in Tinkercad. Pupils screenshot or photo their labelled plan — they will build it next lesson. Plenary: a row of houses can be made by grouping and duplicating. Self-tick the four "I can…".
