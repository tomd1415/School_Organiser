...
- to size 3D objects accurately
- to use a placeholder to make a hole
- to combine a number of 3D objects
- to make our own desk tidy
...
- click the number and type an exact size
...
- group it with the solid shape to cut the hole
...
- one good pot can be duplicated to make more

> 🧑‍🏫 Model making one pot fully before pupils start, so they have a clear worked example.

## Build your desk tidy
- make one hollow pot
- duplicate and resize it to make more
- combine the pots into a desk tidy, then screenshot it

> 🧑‍🏫 You-do. Plenary: what other static objects could you 3D model? Pupils self-tick the four "I can…". Movement break before next lesson.
