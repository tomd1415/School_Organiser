...
![A microcontroller chip]({{res:l1-microcontroller-chip.png}})
...
![The Raspberry Pi Pico board]({{res:l1-pico-board.png}})
...
![Physical computing components: Pico, sensors, motor board, parts]({{res:l1-components.png}})
...
![An LED wired to the Pico on a breadboard]({{res:l1-led-circuit.png}})
