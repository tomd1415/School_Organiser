...
![The L298N motor controller board]({{res:l2-l298n-motor-controller-board-teach-computing.png}})
...
## The pin map
![Raspberry Pi Pico pinout]({{res:l2-raspberry-pi-pico-pinout-teach-computing.png}})
...
## I-do — wire it up
![Two DC motors wired to the controller]({{res:l2-motors-wired-to-the-controller-teach-computing.png}})
