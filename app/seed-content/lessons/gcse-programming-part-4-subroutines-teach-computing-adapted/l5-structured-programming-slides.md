...
![Structure chart for the dog-walking weekly invoice — the main program splits into number of dogs, days walked, total walks, total charge and invoice]({{res:l5-structure-chart-dog-walking-invoice-teach-computing.png}})
