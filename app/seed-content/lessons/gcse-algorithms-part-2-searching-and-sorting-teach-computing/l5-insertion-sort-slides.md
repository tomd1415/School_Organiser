...
![A hand holding playing cards arranged in order]({{res:l5-a-hand-of-cards-teach-computing.png}})
...
![Inserting a card: bigger sorted cards slide right to make a gap for the new card]({{res:l5-inserting-a-card-teach-computing.png}})
