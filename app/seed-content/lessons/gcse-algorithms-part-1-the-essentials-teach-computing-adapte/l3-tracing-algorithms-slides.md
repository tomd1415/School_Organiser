...
![A flowchart that loops while count is less than 5, adding count to total]({{res:l3-starter-flowchart-count-loop-teach-computing.png}})
...
![Python code for Russian multiplication]({{res:l3-russian-multiplication-code-teach-computing.png}})
