...
export const ADAPT_LESSON_SYSTEM =
  ...
  'specific class. Re-pitch it for THIS class using everything known about them: their class ' +
  'teaching-context notes, ability midpoint and access needs — and, WHERE AVAILABLE, how their ' +
  'recent lessons actually went. Where recent-lesson notes are given, pick up exactly where they ' +
  'stopped, recap what the notes say was shaky, and drop or shrink what the notes say overran; ' +
