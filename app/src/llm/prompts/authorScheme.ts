...
export const AUTHOR_SCHEME_VERSION = 'author_scheme@3'; // @3: curriculum history (prior schemes + class coverage) prepended
...
export const AUTHOR_SCHEME_SYSTEM =
  ...
  'unless the brief clearly implies otherwise. Where existing schemes or class history are ' +
  'provided, design the NEXT step of the curriculum: continue from what was covered, recap briefly ' +
  'where it helps, and do not repeat whole units already taught. Never reference individual pupils by name.';
