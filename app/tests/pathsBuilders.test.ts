...
describe('paths builders — exact URLs', () => {
  it.each<[string, string]>([
    ...
    [paths.kit(), '/kit'],
    [paths.progression(), '/progression'],
    [paths.progressionScheme(3), '/progression/scheme/3'],
    [paths.progressionAssign(), '/progression/assign'],
    [paths.progressionPupil(42), '/progression/pupil/42'],
    [paths.progressionClass(7), '/progression/class/7'],
    [paths.progressionSchemeMap(3), '/progression/scheme/3/map'],
    [paths.progressionSpecLink(), '/progression/spec-link'],
    [paths.progressionEvidenceConfirm(), '/progression/evidence/confirm'],
    [paths.me(), '/me'],
    [paths.homework(), '/homework'],
    [paths.homeworkSet(), '/homework/set'],
    [paths.homeworkClear(), '/homework/clear'],
    [paths.ta(), '/ta'],
    ...
    [paths.lessonDoc(3), '/lesson-doc/3'],
